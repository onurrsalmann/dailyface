...
$kadi = $_SESSION["kadi"]; $profil = new Profil();
    if($_GET){
      $search = $_GET["search"];
      echo '
      <!doctype html>
          ...
          <div class="row h-100">
            ...
            <div class="col-8" style="height:100%;">
              ...
              <h2>Arama Sonuçları</h2>
                ...
                $search_class->Search($search); echo'
              </div>
            </div>
            <div class="col-3" style="height:100%;">
              ...
              <div class="profil">
                '; $kadi = $_SESSION["kadi"]; $profil = new Profil(); echo '
                <div class="baslik" style="padding:3%;">
                  <a style="font-size: 150%;">Profil</a>
                </div>
                <div class="profil-bilgi">
                  <img class="profil-pp" src="../../fotograflar/pp/'; echo $profil->ProfilVeriCek($kadi,'pp'); echo '">
                  <a class="profil-bilgi-baslik">Ad: </a><a class="profil-bilgi-icerik">'; echo $profil->ProfilVeriCek($kadi,'adi'); echo ' </a></br>
                  <a class="profil-bilgi-baslik">Kullanıcı Adı:</a><a class="profil-bilgi-icerik"> @'; echo $profil->ProfilVeriCek($kadi,'kadi'); echo '</a></br>
                  <a class="profil-bilgi-baslik">E-posta:</a><a class="profil-bilgi-icerik">'; echo $profil->ProfilVeriCek($kadi,'eposta'); echo '</a>
                </div>
                <div class="profil-post">
                  '; $profil->Postlar($kadi,'../../','../../'); echo '
                </div>
