            ...
            <div class="search">
              ...
              <div class="profil">
                ...
                <div class="profil-bilgi">
                  <img class="profil-pp" src="../fotograflar/pp/'.$profil->ProfilVeriCek($kadi,'pp').'">
                  <a class="profil-bilgi-baslik">Ad: </a><a class="profil-bilgi-icerik">'.$profil->ProfilVeriCek($kadi,'adi').'</a></br>
                  <a class="profil-bilgi-baslik">Kullanıcı Adı:</a><a class="profil-bilgi-icerik"> @'.$profil->ProfilVeriCek($kadi,'kadi').'</a></br>
                  <a class="profil-bilgi-baslik">E-posta:</a><a class="profil-bilgi-icerik">'.$profil->ProfilVeriCek($kadi,'eposta').'</a>
                </div>
                <div class="profil-post">';$profil->Postlar($kadi,"","../"); echo '
                </div>
