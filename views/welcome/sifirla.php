...
if(isset($_GET['token']) == "token"){
		...
		<html lang="tr">
		  <head>
		    ...
		    <title>dailyface-yeni-sifre</title>
		  </head>
		  <body>
		    ...
		    <div class="container-fluid h-100">
		        <div class="row h-100">
		                ...
		                <div class="log">
		                    <div class="log-in">
		                        ...
		                        <div class="log-in-form">
		                                <form action="" method="POST" class="log-in-formm">
		                                    <input required class="form-input" type="password" placeholder="Yeni Şifrenizi Giriniz..." name="sifre"><br/>
		                                    <input name="passsubmit" class="form-button" type="submit" value="Şifreyi Sıfırla">
		                                </form>
		                        </div>
		                    </div>
		                    <div class="sing-in">
		            ...
		            <div class="col-8" style="padding:0px;"><img src="images/bg.png" style="width:100%; height:100%;"/></div>
		        </div>
		    </div>
		</body>
		</html>
